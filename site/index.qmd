...
subtitle: "IIT Bombay campus — from an AutoCAD drawing to a knowledge graph you can question"
page-layout: full
toc: false
---
...
2. a hydraulic model on somebody's laptop
3. a spreadsheet of sensor locations
4. a firmware repository
5. a diagram of what those sensors measure

Each is intelligible alone. None can answer a question that spans two of them.

PLACEHOLDER
the estate office, a hydraulic model on somebody's laptop, a spreadsheet of
sensor locations, a firmware repository, and a diagram of what those sensors
measure. Each is intelligible alone. None can answer a question that spans two
of them.
...
of the network, the diameter annotations come in four different notations, and
...
import produces something EPANET refuses to solve, and the failure is a bare
`Error 110` with no hint that the cause is topological.

Most of the engineering here is getting from that drawing to a graph a solver
will accept, without silently deleting the parts that do not fit.
